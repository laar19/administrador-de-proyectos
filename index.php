...
<div class="contenedor">
    ...
    <main class="contenido-principal">
        ...
        ?>
                ...
                </form> <!-- <form action="#" class="agregar-tarea"> -->
                ...
                <ul>
                    ...
                    ?>
                                <li id="tarea:<?php echo $tarea['id']; ?>" class="tarea">
                                    ...
                                    <div class="acciones">
                                        <i class="far fa-check-circle <?php echo ($tarea['estado'] === '1' ? 'completo' : '') //operador ternario. If de una sóla línea. if tarea["estado"] === "1" agrega la clase completo sino no agrega nada ?>"></i>
